...
<%
	...
	try {
		...
		conn = DriverManager.getConnection("[db주소]", "[아이디]", "[비번]");
...
<link rel="stylesheet" type="text/css" href="daumMapCss.css">
...
<body>
	...
	<script>
		...
		//마커의 이미지 객체를 정의한다. 
		//기본 마커1
		var imageSrc = "basicmarker.png";
		var imageSize = new daum.maps.Size(12, 17);
		var markerImage = new daum.maps.MarkerImage(imageSrc, imageSize);
		//내 위치 마커2
		var imageSrc_my = "walker.gif";
